...
export interface ApiChatChat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    friend: Schema.Attribute.Relation<'oneToOne', 'api::friend.friend'>;
    isTemp: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMatchBuddyMatchBuddy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::match-buddy.match-buddy'
    > &
      Schema.Attribute.Private;
    matchedUsers: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
...
export interface ApiProgressGoalProgressGoal
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    goalStatus: Schema.Attribute.Enumeration<
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::progress-goal.progress-goal'
    > &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    courses: Schema.Attribute.JSON & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    friendOf: Schema.Attribute.Relation<'oneToMany', 'api::friend.friend'>;
    ...
    > &
      Schema.Attribute.Private;
    match_buddies: Schema.Attribute.Relation<
      'manyToMany',
      'api::match-buddy.match-buddy'
    >;
    match_buddy: Schema.Attribute.Relation<
      'oneToOne',
      'api::match-buddy.match-buddy'
    >;
    myFriends: Schema.Attribute.Relation<'oneToMany', 'api::friend.friend'>;
    onlineStatus: Schema.Attribute.Enumeration<['online', 'offline', 'busy']> &
    ...
    progress_goals: Schema.Attribute.Relation<
      'oneToMany',
      'api::progress-goal.progress-goal'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::match-buddy.match-buddy': ApiMatchBuddyMatchBuddy;
      'api::progress-goal.progress-goal': ApiProgressGoalProgressGoal;
